...
if( ! class_exists( 'SS_Foundation_Footer' ) ) {
	/**
	* Build the Shoestrap Footer module class.
	*/
	class SS_Foundation_Footer {
		...
		function html() {
			...
			echo '<div id="footer-copyright">';
				echo $ss_framework->open_row( 'div' );
					echo $ss_framework->open_col( 'div', array( 'large' => $width ), 'copyright-bar' ) . $ftext . $ss_framework->close_col( 'div' );
